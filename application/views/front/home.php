    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption text-left">
                <h1 class="display-2">HANS HOTEL?!</h1>
                <h3>Allrecipes, we are here to serve you</h3>
...
<div class="container-fluid padding">
    <div class="row text-center welcome">
        <div class="col-12">
            <h1 class="display-4">Make an order with only few steps To Follow</h1>
        </div>
        <hr>
        <div class="col-12">
            <p class="lead">HANS HOTEL has several branches which provides easiest way to your food. Procedure of making food is simplied with the use of computerized recipes. Food Ordering  provides fresh delivery
                within the few minutes and provide offers if order is not on time. Start ordering right now and enjoy 15% discount!</p>
        </div>
    </div>
</div>
<div class="container-fluid padding">
    <div class="row text-center padding">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <h3>Pick A Tasty Dish</h3>
            <p>We've got you covered with menus from over various delivery restaurants online!</p>
        </div>
        <div class="col-sm-12 col-md-4">
        <i class="fas fa-clipboard-check"></i>
            <h3>Pick Up or Delivery or Refund</h3>
            <p>After all, the food gets delivered or you can pick it up as per your choices! and refund is made for the spoilt dish</p>
        </div>
    </div>
    <hr class="my-4">
</div>
<div class="container-fluid padding">
    <div class="row welcome text-center welcome">
        <div class="col-12">
            <h1 class="display-4">Trending Dishes</h1>
        </div>
        <hr>
    </div>
</div>
